...
export default function HeroCarousel({ tutors }: { tutors: CarouselTutor[] }) {
  ...
  return (
    <div
      className="mx-3 md:mx-6 mb-12 md:mb-16"
      style={{
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: "linear-gradient(to bottom, transparent 70%, rgba(31,31,39,0.6) 100%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent 30%, rgba(31,31,39,0.3) 45%, rgba(31,31,39,0.5) 55%, rgba(31,31,39,0.65) 70%, rgba(31,31,39,0.75) 85%)",
          }}
        />
        ...
        >
          ...
          <div className="flex lg:hidden absolute inset-x-0 bottom-0 z-10 flex-col items-center justify-end px-6 pb-16 text-center">
            ...
            />
            <p
              className="text-sm font-normal leading-relaxed [&_br]:hidden"
        ...
        >
          ...
          >
            ...
            <span
              ...
              style={{
                color: progress > 0.5 ? "#1F1F27" : "rgba(255,255,255,0.9)",
